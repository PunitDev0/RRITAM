    ...
    <section className="py-10 bg-white text-black min-h-screen">
      <div className="container mx-auto w-4/5 text-justify">
        ...
        <p className="text-sm text-gray-600 text-center mb-8">
          Last updated on <strong>05-04-2025 13:52:44</strong>
        </p>

        <div className="space-y-5 text-base leading-7 font-light">
          <p>
            ...
            <strong>RRITAM REALITY LLP</strong> (“Website Owner”, “we”, “us” or
          ...
          <ul className="list-disc pl-6 space-y-3">
            ...
            <li>
              ...
              ensure that the Services meet your requirements. The contents of
              the Website and the Services are proprietary to us and you will
              not have any authority to claim any intellectual property rights,
          ...
          <p>
            ...
            with the laws of <strong>India</strong>.
          </p>
